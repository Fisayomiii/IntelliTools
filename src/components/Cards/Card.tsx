...
const Card = ({ tool }: any) => {
    return (
        <>
            <motion.div layout animate={{ opacity: 1}} initial={{ opacity: 0 }} exit={{ opacity: 0 }} className="max-w-sm max-h-fit bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg dark:bg-zinc-800">
