const Card = ({ tool }: any) => {
    return (
        <>
            <div className="max-w-sm max-h-fit bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg dark:bg-zinc-800">
