      ...
      <header className="backdrop-filter backdrop-blur-lg fixed top-4 left-4 right-4 sm:left-64 sm:right-64 z-50 rounded-lg shadow-lg transition-all border border-slate-500 hover:border-slate-600">
        <nav className="flex justify-between items-center py-2 px-6">
          ...
          <div className="flex items-center justify-center">
            ...
            <button className="animate__animated animate__fadeInUp text-gray-900 font-medium rounded-full">
              <DarkModeToggle />
            </button>

            <button className="animate__animated animate__fadeInUp animate__delay-1s text-gray-900 font-medium py-2 px-4 rounded-full" title="Star on Github 🙏">
            ...
            <button className="animate__animated animate__fadeInUp animate__delay-2s text-gray-900 font-medium rounded-full" title="Give me a follow">
